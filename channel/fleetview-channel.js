...
const mcp = new Server(
  { name: 'fleetview', version: '1.0.0' },
  {
    ...
    instructions:
      ...
      '평소처럼 작업하고 평소처럼 답하세요. 답을 쓴 뒤 fleetview_reply 도구를 한 번 호출해 ' +
      '같은 사용자에게 그 답이 대시보드에도 보이게 하세요. ' +
      '중요: text 에는 방금 화면에 쓴 답을 그대로 넣으세요. ' +
      '"답변을 보냈습니다" 같은 요약이나 설명을 새로 쓰지 마세요. ' +
      '같은 사람이 같은 대화를 두 화면에서 보고 있으므로 내용이 다르면 혼란스럽습니다. ' +
